...
function show_hide( value, num1, num2 )
{
  var shdoc = document.getElementById('mag'+num1);
  var hidoc = document.getElementById('mag'+num2);
  if ( value != 'HL' )
  {
    shdoc.style.display = 'block';
    hidoc.style.display = 'none';
  }
  else
  {
    shdoc.style.display = 'none';
    hidoc.style.display = 'block';
  }
}
